...
class Pendulum:
    def __init__(self, client):
        ...
        self.pendulum = p.loadURDF(fileName=f_name,
                                   basePosition=[0, 0, 1],
    ...
    def get_ids(self):
        return self.pendulum, self.client
    ...
    def apply_action(self, action):
        ...
        # 2 = Release
        if action_type == 0:
            p.setJointMotorControl2(bodyIndex=self.pendulum,
    ...
    def get_observation(self):
        ...
        pos, ang = p.getBasePositionAndOrientation(self.pendulum, self.client)
